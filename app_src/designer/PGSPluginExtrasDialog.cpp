...
#include "PGSPluginExtrasDialog.hpp"
#include "ui_PGSPluginExtrasDialog.h"

PGSPluginExtrasDialog::PGSPluginExtrasDialog(QWidget *parent) :
	QDialog(parent),
	ui(new Ui::PGSPluginExtrasDialog)
{
	ui->setupUi(this);
}

PGSPluginExtrasDialog::~PGSPluginExtrasDialog()
{
	delete ui;
}
